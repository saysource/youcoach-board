...
export function InteractiveBoard({ backgroundMode = false, homographyMode = false, cameraMode = false, zoneMode = false, showGrid = false, navigating = false, navMarkers = false, onNavTap }: { backgroundMode?: boolean; homographyMode?: boolean; cameraMode?: boolean; zoneMode?: boolean; showGrid?: boolean; navigating?: boolean; navMarkers?: boolean; onNavTap?: () => void }) {
  ...
  return (
    ...
    >
      ...
      {field3d && <FieldSceneLayer camera={field3d} viewport={viewport} image={doc.background.image} color={doc.background.color} svgRef={svgRef} containerRef={containerRef} showGoals={doc.background.showGoals} bands={doc.background.bands} fieldType={doc.background.fieldType} layout={doc.background.trainingLayout} surround={doc.background.surroundColor} linesOpacity={doc.background.linesOpacity} centerLight={doc.background.centerLight} renderTick={editing3d} />}
      <BoardCanvas
        doc={doc}
        svgRef={svgRef}
        viewBox={viewBox}
